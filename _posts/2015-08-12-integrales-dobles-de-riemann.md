...
![Parcelación no homogénea de una región R del plano](/taller-matematicas/assets/images/patata-300x200.png) Parcelación no homogénea de una región R del plano
...
![Área R de integración rectangular](/taller-matematicas/assets/images/area_rect-300x205.png) Área R de integración rectangular
...
![Recinto R de integración no rectangular, delimitado por una curva cerrada](/taller-matematicas/assets/images/area_no_rect-300x181.png) Recinto R de integración no rectangular, delimitado por una curva cerrada
...
![Recinto convexo de integración](/taller-matematicas/assets/images/area_convexa-300x185.png) Recinto convexo de integración
...
![Volumen definido por una región R del plano XY y una altura z=f(x,y)](/taller-matematicas/assets/images/volum_R.png) Volumen definido por una región R del plano XY y una altura z=f(x,y)
...
![Región delimitada por las curvas y=x², x²=y](/taller-matematicas/assets/images/regio_R-300x288.png) Región delimitada por las curvas y=x², x²=y
...
![Elemento de área en coordenadas polares](/taller-matematicas/assets/images/area_circular-300x266.png) Elemento de área en coordenadas polares
...
![Recinto delimitado por una elipse en XY y un plano en el espacio](/taller-matematicas/assets/images/recinte-1024x773.png) Recinto delimitado por una elipse en XY y un plano en el espacio
...
![regio2](/taller-matematicas/assets/images/regio2-300x142.png)
