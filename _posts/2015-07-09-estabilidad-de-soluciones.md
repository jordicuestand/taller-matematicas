...
![poblacio2](/taller-matematicas/assets/images/poblacio2.png) Tres soluciones de la ecuación de la población, con distintas poblaciones iniciales; todas convergen para P=M, y divergen para P=0
...
![poblacio3](/taller-matematicas/assets/images/poblacio3.png) Soluciones de la ecuación de la población, misma población inicial, distintos coeficientes k
...
![Recta fase de la ecuación de la población, muestra la tendencia a los lados de los puntos críticos ](/taller-matematicas/assets/images/fase.png) Recta fase de la ecuación de la población, muestra la tendencia a los lados de los puntos críticos
...
![centre_estable](/taller-matematicas/assets/images/centre_estable.png) Trayectorias x(t), y(t) para tres diferentes combinaciones de los parámetros en un oscilador armónico simple; en abscisas tenemos el desplazamiento x, en ordenadas la velocidad y=x'
