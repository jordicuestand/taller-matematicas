...
![](/taller-matematicas/assets/images/ones-2.png) Fig. 1: ondas en el agua. Fuente: http://hyperphysics.phy-astr.gsu.edu/hbasees/Sound/wavplt.html
...
![](/taller-matematicas/assets/images/ones-3.png) Fig.2: Al mover la mano arriba y abajo la cuerda oscila. Los puntos de la cuerda se mueven transversalmente a la dirección de propagación de la oscilación.
...
![](/taller-matematicas/assets/images/ones-5.png) Fig. 4: las olas no transportan agua, el agua sube y baja al paso de las olas, como indica el movimiento de la barca, que no avanza.
...
![](/taller-matematicas/assets/images/ones-6.png) Fig. 5: Ejemplos de ondas longitudinales y transversales
...
![](/taller-matematicas/assets/images/ones-7.png) Fig. 5: longitud de onda
...
![](/taller-matematicas/assets/images/ones-8.png) Fig. 6: descripción del movimiento oscilatorio
