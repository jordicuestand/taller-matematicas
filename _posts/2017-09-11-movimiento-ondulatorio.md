...
[caption id="attachment_150558" align="alignnone" width="413"]![](/assets/images/ones-2.png) Fig. 1: ondas en el agua. Fuente: http://hyperphysics.phy-astr.gsu.edu/hbasees/Sound/wavplt.html[/caption]
...
[caption id="attachment_150559" align="alignnone" width="528"]![](/assets/images/ones-3.png) Fig.2: Al mover la mano arriba y abajo la cuerda oscila. Los puntos de la cuerda se mueven transversalmente a la dirección de propagación de la oscilación.[/caption]
...
[caption id="attachment_150560" align="aligncenter" width="212"]![](/assets/images/ones-4-e1504079237363.png) Fig. 3: al comprimir rápidamente un muelle podemos observar una onda de compresión que avanza por él.[/caption]
...
[caption id="attachment_150569" align="alignnone" width="148"]![](/assets/images/ones-5.png) Fig. 4: las olas no transportan agua, el agua sube y baja al paso de las olas, como indica el movimiento de la barca, que no avanza.[/caption]
...
[caption id="attachment_150571" align="alignnone" width="628"]![](/assets/images/ones-6.png) Fig. 5: Ejemplos de ondas longitudinales y transversales[/caption]
...
[caption id="attachment_150574" align="alignnone" width="539"]![](/assets/images/ones-7.png) Fig. 5: longitud de onda[/caption]
...
[caption id="attachment_150575" align="alignnone" width="359"]![](/assets/images/ones-8.png) Fig. 6: descripción del movimiento oscilatorio[/caption]
