...
![separador](/taller-matematicas/assets/images/separador.png)**2.** Usando el método de máxima verosimilitud, estimar el parámetro p de una distribución binomial de N=10 a partir de una muestra de n=7 repeticiones, con valores {7, 6, 2, 5, 6, 3, 7}.
...
![separador](/taller-matematicas/assets/images/separador.png)**3.** Usando el método de máxima verosimilitud, estimar el parámetro p de una distribución discreta de probabilidad con la siguiente función de probabilidad:
