...
[caption id="attachment_378" align="alignnone" width="450"][![Ejemplo de función continua en todos los puntos, sen(x), y de función con infinitos puntos de discontinuidad, tan(x)](/taller-matematicas/assets/images/funcio_sin_tan.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/funcio_sin_tan.png) Ejemplo de función continua en todos los puntos, sen(x), y de función con infinitos puntos de discontinuidad, tan(x)[/caption]
...
[caption id="attachment_48" align="alignnone" width="523"][![Continuidad: los puntos x en un entorno del punto a tienen imágenes  dentro de un entorno de la imagen f(a)](/taller-matematicas/assets/images/limit_funció_1.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/06/limit_funció_1.png) Continuidad: los puntos x en un entorno del punto a tienen imágenes dentro de un entorno de la imagen L=f(a)[/caption]
...
[caption id="attachment_381" align="aligncenter" width="267"][![Discontinuidad en x=0](/taller-matematicas/assets/images/discontinua_0.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/discontinua_0.png) Discontinuidad en x=0[/caption]
...
[caption id="attachment_384" align="aligncenter" width="256"][![Esta función tiene un punto aislado en x=-1, en donde no puede ser continua.](/taller-matematicas/assets/images/aillat.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/aillat.png) Esta función tiene un punto aislado en x=-1, en donde no puede ser continua.[/caption]
...
[caption id="attachment_388" align="aligncenter" width="416"][![Izquierda: función no inyectiva, derecha: función inyectiva](/taller-matematicas/assets/images/inyectiva-300x103.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/inyectiva.png) Izquierda: función no inyectiva, derecha: función inyectiva[/caption]
...
[caption id="attachment_389" align="aligncenter" width="353"][![Función y=x³ (en azul) y su inversa (en rojo), separadas por la bisectriz y=x, que es el eje de simetría](/taller-matematicas/assets/images/inversa.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/inversa.png) Función y=x³ (en azul) y su inversa (en rojo), separadas por la bisectriz y=x (en negro), que es el eje de simetría.[/caption]
...
[caption id="attachment_390" align="alignnone" width="465"][![Gráfica de y=x² (en azul) y  su simétrica respecto al eje y=x (en rojo). Esta última gráfica no es una función.](/taller-matematicas/assets/images/no_inversa.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/no_inversa.png) Gráfica de y=x² (en azul) y, en rojo, su simétrica respecto al eje y=x (en negro). Esta última gráfica no puede ser una función.[/caption]
...
[caption id="attachment_396" align="alignnone" width="399"][![Función continua en un intervalo cerrado](/taller-matematicas/assets/images/maxim_i_minim.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/maxim_i_minim.png) Función continua en un intervalo cerrado [0.2, 6], presenta un máximo local en x=3.8,  mínimos locales en x=1.5 y en x=5.5, máximo absoluto en x=0.2, mínimo absoluto en x=1.5. El teorema de Weierstrass garantiza la existencia de los extremos absolutos, no dice nada acerca de los extremos relativos.[/caption]

[caption id="attachment_397" align="alignleft" width="107"][![Función discontinua en un intervalo cerrado](/taller-matematicas/assets/images/no_maxim_i_minim1.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/no_maxim_i_minim1.png) Función discontinua en un intervalo cerrado[/caption]
...
[caption id="attachment_405" align="alignleft" width="306"][![Teorema de Bolzano: si una función continua cambia de signo en un intervalo, entonces debe de cortar al eje X en algún punto](/taller-matematicas/assets/images/Bolzano.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/Bolzano.png) Teorema de Bolzano: si una función continua cambia de signo en un intervalo, entonces debe de cortar al eje X en algún punto[/caption]
...
[caption id="attachment_52" align="alignnone" width="478"][![Límite para x=a de la función y=x²](/taller-matematicas/assets/images/limit_funció_21.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/06/limit_funció_21.png) Límite para x=a de la función y=x²[/caption]
...
[caption id="attachment_417" align="alignnone" width="323"][![Disminución de r, para un R dado, a medida que x aumenta](/taller-matematicas/assets/images/continuitat_uniforme.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/continuitat_uniforme.png) Disminución de r, para un R dado, a medida que x aumenta[/caption]
