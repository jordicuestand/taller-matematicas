...
[caption id="attachment_1589" align="alignnone" width="255"]![Diferencia de energía potencial y sentido de la corriente](/assets/images/desnivell.png) Fig. 1:Diferencia de energía potencial y sentido de la corriente[/caption]
...
[caption id="attachment_1597" align="alignnone" width="300"]![Fig. 3: E1 actúa como f.e.m., E2 actúa como f.c.e.m.](/assets/images/fcem-300x98.png) Fig. 3: E1 actúa como f.e.m., E2 actúa como f.c.e.m.[/caption]
...
[caption id="attachment_1600" align="alignnone" width="300"]![](/assets/images/circuit-simpleCC-300x164.png) Fig. 4: Circuito simple completo en CC[/caption]
...
[caption id="attachment_1604" align="alignnone" width="461"]![Asociaciones de resistencias](/assets/images/asoc_resistencies.png) Fig. 5: Asociaciones de resistencias[/caption]
...
[caption id="attachment_1608" align="alignnone" width="419"]![asoc_resistencies_exemple](/assets/images/asoc_resistencies_exemple.png) Fig. 6: circuito con asociaciones de resistencias[/caption]
...
[caption id="attachment_1607" align="alignnone" width="300"]![Fig. 6: Asociaciones en paralelo y en serie de generadores](/assets/images/asoc_generadors-300x200.png) Fig. 6: Asociaciones en paralelo y en serie de generadores[/caption]
...
[caption id="attachment_1616" align="alignnone" width="231"]![Fig. 7: asociaciones de generadores y resistencias](/assets/images/asoc_generadors_exemple.png) Fig. 7: asociaciones de generadores y resistencias[/caption]
...
[caption id="attachment_1586" align="alignnone" width="433"]![Fig. 1: red eléctrica con dos circuitos.](/assets/images/CircuitCCP47.png) Fig. 8: red eléctrica con dos circuitos.[/caption]
...
[caption id="attachment_1620" align="alignnone" width="474"]![Resolviendo on-line el sistema lineal con Wolfram Alpha, llamamos x=I1, y=I2, z=I3](/assets/images/wolfram_sistema_lineal.png) Resolviendo on-line el sistema lineal con Wolfram Alpha, llamamos x=I1, y=I2, z=I3[/caption]
...
![tram_Ohm](/assets/images/tram_Ohm.png)
