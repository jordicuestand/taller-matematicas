...
![Diferencia de energía potencial y sentido de la corriente](/taller-matematicas/assets/images/desnivell.png) Fig. 1:Diferencia de energía potencial y sentido de la corriente
...
![Fig. 3: E1 actúa como f.e.m., E2 actúa como f.c.e.m.](/taller-matematicas/assets/images/fcem-300x98.png) Fig. 3: E1 actúa como f.e.m., E2 actúa como f.c.e.m.
...
![](/taller-matematicas/assets/images/circuit-simpleCC-300x164.png) Fig. 4: Circuito simple completo en CC
...
![Asociaciones de resistencias](/taller-matematicas/assets/images/asoc_resistencies.png) Fig. 5: Asociaciones de resistencias
...
![asoc_resistencies_exemple](/taller-matematicas/assets/images/asoc_resistencies_exemple.png) Fig. 6: circuito con asociaciones de resistencias
...
![Fig. 6: Asociaciones en paralelo y en serie de generadores](/taller-matematicas/assets/images/asoc_generadors-300x200.png) Fig. 6: Asociaciones en paralelo y en serie de generadores
...
![Fig. 7: asociaciones de generadores y resistencias](/taller-matematicas/assets/images/asoc_generadors_exemple.png) Fig. 7: asociaciones de generadores y resistencias
...
![Fig. 1: red eléctrica con dos circuitos.](/taller-matematicas/assets/images/CircuitCCP47.png) Fig. 8: red eléctrica con dos circuitos.
...
![Resolviendo on-line el sistema lineal con Wolfram Alpha, llamamos x=I1, y=I2, z=I3](/taller-matematicas/assets/images/wolfram_sistema_lineal.png) Resolviendo on-line el sistema lineal con Wolfram Alpha, llamamos x=I1, y=I2, z=I3
