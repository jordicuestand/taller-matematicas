...
![Fig. 1: ejes ortogonales, base ortogonal, origen de coordenadas, definen una referencia euclídea](/taller-matematicas/assets/images/referencia_euclidea.png) Fig. 1: ejes ortogonales, base ortogonal, origen de coordenadas, definen una referencia euclídea
...
![Fig. 2: dos referencias con distintos orígenes y la misma base](/taller-matematicas/assets/images/referencia_euclidea2.png) Fig. 2: las dos referencias del ejemplo 1
...
![Fig. 6: gráficas de las componentes de la velocidad respecto Ref1](/taller-matematicas/assets/images/velocitat-base-mòbil5.png) Fig. 5: gráficas de las componentes de la velocidad respecto Ref1
