...
![](/taller-matematicas/assets/images/Exercici-3-Termo-1.png) Fig.1: las transformaciones del problema en el diagrama PV
...
![](/taller-matematicas/assets/images/treball-no-conservatiu-2.png) Fig. 2: el trabajo realizado en una transformación de estados depende de todos los estados, no sólo del inicial y el final
...
![](/taller-matematicas/assets/images/Rectangle-PV.png) Fig.2: diagrama PV en forma de rectángulo
...
![](/taller-matematicas/assets/images/diagrama-PV-en-PT.png) Fig. 3: diagrama PT equivalente
