...
![fn(x) = 1/(1+nx²)](/taller-matematicas/assets/images/sucesion-funcional1.jpg) fn(x) = 1/(1+nx²)
...
![fn(x) = |x| / (1 + nx²)](/taller-matematicas/assets/images/sucesion-funcional2.jpg) fn(x) = |x| / (1 + nx²). Los términos a partir del tercero  estan dentro de la franja -0,3 < y < 0,3.
...
![sin(nx) / n^(1/2)](/taller-matematicas/assets/images/sucesion-funcional4.jpg) sin(nx) / n^(1/2)
...
![(x^2n)/(1+x^2n)](/taller-matematicas/assets/images/sucesion-funcional5.jpg) (x^2n)/(1+x^2n)
