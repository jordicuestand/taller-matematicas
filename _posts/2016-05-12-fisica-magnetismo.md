...
[caption id="attachment_1625" align="alignleft" width="294"]![Fig. 1: Magnetita (By Rob Lavinsky, iRocks.com – CC-BY-SA-3.0, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=10139390)](/assets/images/470px-Magnetite-118736-294x300.jpg) Fig. 1: Magnetita (By Rob Lavinsky, iRocks.com – CC-BY-SA-3.0, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=10139390)[/caption]
...
[caption id="attachment_1627" align="alignnone" width="399"]![Fig. 2: la fuerza de inducción magnética sobre una carga en movimiento siempre es perpendicular a la velocidad de la carga](/assets/images/força-induccio.png) Fig. 2: la fuerza de inducción magnética sobre una carga en movimiento siempre es perpendicular a la velocidad de la carga, su módulo depende de la dirección de la velocidad.[/caption]
...
[caption id="attachment_1652" align="alignnone" width="300"]![Fig. 4: sección de un conductor recorrido por una corriente de electrones](/assets/images/element_corrent-300x146.png) Fig. 4: sección de un conductor recorrido por una corriente de electrones[/caption]
...
[caption id="attachment_1660" align="alignnone" width="425"]![Fig.5: Espira rectangular de lado d por la que circula una corriente I, sometida a un campo magnético B](/assets/images/espira-campo-B.png) Fig.5: Espira rectangular de lado d por la que circula una corriente I, sometida a un campo magnético B[/caption]
