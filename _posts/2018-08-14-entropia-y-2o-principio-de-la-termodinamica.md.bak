...
[caption id="attachment_150685" align="alignnone" width="268"]![](/taller-matematicas/assets/images/Carnot-1.png) Fig.1: ciclo de Carnot representado en el diagrama Presión-Volumen[/caption]
...
[caption id="attachment_150706" align="alignnone" width="270"]![](/taller-matematicas/assets/images/recubriment_Carnot.png) Fig.2: ciclo reversible cualquiera, parcialmente recubierto por ciclos de Carnot[/caption]
...
[caption id="attachment_150707" align="alignnone" width="206"]![](/taller-matematicas/assets/images/superposicio-cicles-carnot.png) Fig.3: detalle de dos ciclos contiguos de Carnot  del recubrimiento de un ciclo C[/caption]
...
[caption id="attachment_150708" align="alignnone" width="379"]![](/taller-matematicas/assets/images/circulacio-vector.png) Fig.4: curva C, elemento diferencial dl tangente a C en P, y vector campo v(P) en P[/caption]
...
[caption id="attachment_150709" align="alignnone" width="284"]![](/taller-matematicas/assets/images/ostres.png) Fig.5: un camino cerrado C y algunos de sus puntos, P, Q, R, S[/caption]
...
[caption id="attachment_150714" align="alignnone" width="252"]![](/taller-matematicas/assets/images/sistema-tancat.png) Fig.6: Sistema aislado del exterior, con una transferencia interna de calor Q[/caption]
...
[caption id="attachment_150720" align="alignnone" width="387"]![](/taller-matematicas/assets/images/irreversible.png) Fig. 7: transformación irreversible y camino reversible alternativo[/caption]
...
[caption id="attachment_150742" align="alignnone" width="371"]![](/taller-matematicas/assets/images/diagrama-TS-Carnot.png) Fig.8: un ciclo de Carnot visto en el diagrama TS[/caption]
...
[caption id="attachment_150726" align="alignnone" width="304"]![](/taller-matematicas/assets/images/maquina-perpetua.png) Fig.8: esquema de una máquina térmica perpetua, que constituye un sistema aislado que se retroalimenta[/caption]
...
[caption id="attachment_150727" align="alignleft" width="246"]![](/taller-matematicas/assets/images/TeoremaCarnot-246x300.png) Fig.9: esquema para demostrar el teorema de Carnot con dos máquinas de Carnot conectadas entre sí[/caption]
...
[caption id="" align="alignnone" width="634"]![](/taller-matematicas/assets/images/igual-W.png) Fig.10: dos ciclos entre distintas isotermas y adiabáticas, ajustados para tener la misma área W[/caption]
...
[caption id="attachment_150730" align="alignnone" width="300"]![](/taller-matematicas/assets/images/TeoremaCarnot2-300x238.png) Fig.11: combinación de máquinas térmicas equivalente a una que viola el 2º principio[/caption]
...
[caption id="attachment_150731" align="alignleft" width="276"]![](/taller-matematicas/assets/images/TeoremaCarnot3-276x300.png) Fig.12: con rendimentos iguales, la combinación propuesta equivale a una máquina nula que no transfiere calor ni trabajo y por tanto no vulnera ningún principio[/caption]
