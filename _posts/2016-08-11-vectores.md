...
$caption id="attachment_150012" align="alignnone" width="338"$![Fig. 3: reflexión de un punto sobre el eje de abscisas X](/taller-matematicas/assets/images/reflexio_pla.png) Fig. 3: reflexión de un punto sobre el eje de abscisas X
...
![](https://upload.wikimedia.org/wikipedia/commons/b/b0/Vector-omega.svg) Fig. 5: pseudovector velocidad angular, fuente: LP. via Wikimedia Commons
...
$caption id="attachment_150014" align="alignnone" width="499"$![Fig. 6: movimiento circular plano y signo de la velocidad angular](/taller-matematicas/assets/images/vel_angular.png) Fig. 6: movimiento circular plano y signo de la velocidad angular
...
$caption id="attachment_150015" align="alignnone" width="250"$![Fig.7: pseudovector w como producto vectorial de vectores polares u, v](/taller-matematicas/assets/images/producte-vectorial.png) Fig.7: pseudovector w como producto vectorial de vectores polares u, v. Fuente: es.wikipedia.org/wiki/Producto_vectorial
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Cartesian_coordinate_system_handedness.svg/400px-Cartesian_coordinate_system_handedness.svg.png) Fig. 7: orientación relativa de los ejes en tres dimensiones. Fuente: Wikipedia under GFDL by en:User:Tarquin
...
![Fig. 8: partícula con un movimiento radial sobre un disco giratorio](/taller-matematicas/assets/images/exemple_mecanica_vect-300x226.png) Fig. 8: partícula con un movimiento radial sobre un disco giratorio
...
![](https://wikimedia.org/api/rest_v1/media/math/render/svg/8097523c109bf46df802db54996da37ba25f9d13) Ley de Faraday. Fuente: https://es.wikipedia.org/wiki/Ecuaciones_de_Maxwell
