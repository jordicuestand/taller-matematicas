...
[![Discontinuidad en x=0](/taller-matematicas/assets/images/discontinua_0.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/discontinua_0.png) Discontinuidad en x=0
...
[![Esta función tiene un punto aislado en x=-1, en donde no puede ser continua.](/taller-matematicas/assets/images/aillat.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/aillat.png) Esta función tiene un punto aislado en x=-1, en donde no puede ser continua.
...
[![Izquierda: función no inyectiva, derecha: función inyectiva](/taller-matematicas/assets/images/inyectiva-300x103.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/inyectiva.png) Izquierda: función no inyectiva, derecha: función inyectiva
...
[![Función y=x³ (en azul) y su inversa (en rojo), separadas por la bisectriz y=x, que es el eje de simetría](/taller-matematicas/assets/images/inversa.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/inversa.png) Función y=x³ (en azul) y su inversa (en rojo), separadas por la bisectriz y=x (en negro), que es el eje de simetría.
...
$caption id="attachment_52" align="alignnone" width="478"$[![Límite para x=a de la función y=x²](/taller-matematicas/assets/images/limit_funció_21.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/06/limit_funció_21.png) Límite para x=a de la función y=x²
...
$caption id="attachment_417" align="alignnone" width="323"$[![Disminución de r, para un R dado, a medida que x aumenta](/taller-matematicas/assets/images/continuitat_uniforme.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/09/continuitat_uniforme.png) Disminución de r, para un R dado, a medida que x aumenta
