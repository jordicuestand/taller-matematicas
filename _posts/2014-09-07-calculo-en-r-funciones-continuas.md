...
![Ejemplo de función continua en todos los puntos, sen(x), y de función con infinitos puntos de discontinuidad, tan(x)](/taller-matematicas/assets/images/funcio_sin_tan.png) Ejemplo de función continua en todos los puntos, sen(x), y de función con infinitos puntos de discontinuidad, tan(x)
...
![Continuidad: los puntos x en un entorno del punto a tienen imágenes  dentro de un entorno de la imagen f(a)](/taller-matematicas/assets/images/limit_funció_1.png) Continuidad: los puntos x en un entorno del punto a tienen imágenes dentro de un entorno de la imagen L=f(a)
...
![Discontinuidad en x=0](/taller-matematicas/assets/images/discontinua_0.png) Discontinuidad en x=0
...
![Esta función tiene un punto aislado en x=-1, en donde no puede ser continua.](/taller-matematicas/assets/images/aillat.png) Esta función tiene un punto aislado en x=-1, en donde no puede ser continua.
...
![Izquierda: función no inyectiva, derecha: función inyectiva](/taller-matematicas/assets/images/inyectiva-300x103.png) Izquierda: función no inyectiva, derecha: función inyectiva
...
![Función y=x³ (en azul) y su inversa (en rojo), separadas por la bisectriz y=x, que es el eje de simetría](/taller-matematicas/assets/images/inversa.png) Función y=x³ (en azul) y su inversa (en rojo), separadas por la bisectriz y=x (en negro), que es el eje de simetría.
...
![Gráfica de y=x² (en azul) y  su simétrica respecto al eje y=x (en rojo). Esta última gráfica no es una función.](/taller-matematicas/assets/images/no_inversa.png) Gráfica de y=x² (en azul) y, en rojo, su simétrica respecto al eje y=x (en negro). Esta última gráfica no puede ser una función.
...
![Función continua en un intervalo cerrado](/taller-matematicas/assets/images/maxim_i_minim.png) Función continua en un intervalo cerrado [0.2, 6], presenta un máximo local en x=3.8,  mínimos locales en x=1.5 y en x=5.5, máximo absoluto en x=0.2, mínimo absoluto en x=1.5. El teorema de Weierstrass garantiza la existencia de los extremos absolutos, no dice nada acerca de los extremos relativos.

![Función discontinua en un intervalo cerrado](/taller-matematicas/assets/images/no_maxim_i_minim1.png) Función discontinua en un intervalo cerrado
...
![Teorema de Bolzano: si una función continua cambia de signo en un intervalo, entonces debe de cortar al eje X en algún punto](/taller-matematicas/assets/images/Bolzano.png) Teorema de Bolzano: si una función continua cambia de signo en un intervalo, entonces debe de cortar al eje X en algún punto
...
En la primera definición hemos usado el concepto de límite:  decíamos que debe existir el límite $L=\lim_{x\rightarrow a}f\left(x\right)\neq\pm\infty$ y además cumplirse que $L=f(a)$.  Si existe el límite, entonces por la definición de límite de una función en un punto (ver por ejemplo: [Límites de funciones de variable real, teoria](/taller-matematicas/2014/07/13/limites-de-funciones-reales-de-variable-real/)) se cumplirá la condición:
...
![Límite para x=a de la función y=x²](/taller-matematicas/assets/images/limit_funció_21.png) Límite para x=a de la función y=x²
...
![Disminución de r, para un R dado, a medida que x aumenta](/taller-matematicas/assets/images/continuitat_uniforme.png) Disminución de r, para un R dado, a medida que x aumenta
