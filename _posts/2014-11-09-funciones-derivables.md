...
![Relación entre pendiente y ángulo](/taller-matematicas/assets/images/Tan-300x233.png)Relación entre pendiente y ángulo
...
![Función no derivable en el origen: la pendiente en ese punto no está definida](/taller-matematicas/assets/images/no_derivable-300x230.png)Función no derivable en el origen: la pendiente en ese punto no está definida
...
![Aproximación local a la función y=f(x) mediante su recta tangente](/taller-matematicas/assets/images/recta_tangent_21.png)Aproximación local a la función y=f(x) mediante su recta tangente
