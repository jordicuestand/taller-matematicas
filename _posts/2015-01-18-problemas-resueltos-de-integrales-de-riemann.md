...
$caption id="attachment_763" align="alignnone" width="300"$[![Àrea de la región delimitada por la elipse y la región x>2](/taller-matematicas/assets/images/area_elipse-300x247.png)](http://tallermatematic.eu/wp/wp-content/uploads/2015/01/area_elipse.png) Àrea de la región delimitada por la elipse y la región x>2
...
$caption id="attachment_782" align="alignnone" width="464"$[![Exer6_problemes_integrals](/taller-matematicas/assets/images/Exer6_problemes_integrals.png)](http://tallermatematic.eu/wp/wp-content/uploads/2015/01/Exer6_problemes_integrals.png) Función decreciente (azul) con derivada creciente (rojo)
