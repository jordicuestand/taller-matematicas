...
![](/taller-matematicas/assets/images/20170822_084811.jpg) Fig. 1: un diapasón, una varilla rectangular doblada en forma de horquilla, vibra de forma armónica simple al ser golpeado en un extremo
### Tono de un sonido
...
![](/taller-matematicas/assets/images/so-1-300x183.png) Fig.2: ondas sinusoidales, como las que produce un diapasón. La línea azul representa un sonido de la mitad de tono que la linea roja.
...
![](/taller-matematicas/assets/images/so-2-300x185.png) Fig. 3: dos oscilaciones sinusoidales de la misma frecuencia y distinta amplitud.
...
![](/taller-matematicas/assets/images/so-3.png) Fig. 4: sonido de un instrumento, en este caso de la tecla de un piano, mostrando pequeñas deformaciones que acompañan a la onda fundamental.
...
![](/taller-matematicas/assets/images/so-4.png) Fig. 5: Área normal de audición, en frecuencias-decibelios.
