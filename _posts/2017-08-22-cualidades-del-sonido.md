...
$caption id="attachment_150528" align="alignnone" width="1280"$![](/taller-matematicas/assets/images/20170822_084811.jpg) Fig. 1: un diapasón, una varilla rectangular doblada en forma de horquilla, vibra de forma armónica simple al ser golpeado en un extremo
### Tono de un sonido
...
$caption id="attachment_150529" align="alignnone" width="300"$![](/taller-matematicas/assets/images/so-1-300x183.png) Fig.2: ondas sinusoidales, como las que produce un diapasón. La línea azul representa un sonido de la mitad de tono que la linea roja.
...
$caption id="attachment_150530" align="alignnone" width="300"$![](/taller-matematicas/assets/images/so-2-300x185.png) Fig. 3: dos oscilaciones sinusoidales de la misma frecuencia y distinta amplitud.
...
$caption id="attachment_150531" align="alignnone" width="600"$![](/taller-matematicas/assets/images/so-3.png) Fig. 4: sonido de un instrumento, en este caso de la tecla de un piano, mostrando pequeñas deformaciones que acompañan a la onda fundamental.
...
$caption id="attachment_150532" align="alignnone" width="706"$![](/taller-matematicas/assets/images/so-4.png) Fig. 5: Área normal de audición, en frecuencias-decibelios.
