...
[![separador2](/assets/images/separador2-150x50.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/08/separador2.png)
...
[![separador2](/assets/images/separador2-150x50.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/08/separador2.png)**6.** Estudiar si la serie $\sum_{n=0}^\infty\frac{2n+1}{2^n}$ es convergente, y si lo es, obtener su suma.
...
[![separador2](/assets/images/separador2-150x50.png)](http://tallermatematic.eu/wp/wp-content/uploads/2014/08/separador2.png)**8.** Ver si la serie $\sum_{k=0}^\infty\left(-1\right)^k\frac{k^3}{k!}$ es convergente y si es absolutamente convergente.
