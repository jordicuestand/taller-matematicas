...
![Fig. 1: rotaciones alrededor de los ejes cartesianos](/taller-matematicas/assets/images/rotacions-300x239.png) Fig. 1: rotaciones alrededor de los ejes cartesianos
...
![Fig. 2: combinación de dos rotaciones en el espacio, tomadas en distinto orden](/taller-matematicas/assets/images/rotacions2.png) Fig. 2: combinación de dos rotaciones en el espacio, tomadas en distinto orden
...
![](/taller-matematicas/assets/images/Euler3-2.png) Fig. 5: tercera rotación de Euler, posición final, se indican los vectores rotación en rojo
...
![Fig. 6: composición simple de rotaciones](/taller-matematicas/assets/images/suma_rotacions.png) Fig. 6: composición simple de rotaciones
...
![Fig. 7: ejes y ángulos de Euler para el volante del problema](/taller-matematicas/assets/images/cinematica_volant2.png) Fig. 8: una elección posible de ejes y ángulos de Euler para el volante del problema
