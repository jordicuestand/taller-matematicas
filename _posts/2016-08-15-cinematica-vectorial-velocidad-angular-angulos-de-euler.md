...
$caption id="attachment_150075" align="alignnone" width="300"$![Fig. 1: rotaciones alrededor de los ejes cartesianos](/taller-matematicas/assets/images/rotacions-300x239.png) Fig. 1: rotaciones alrededor de los ejes cartesianos
...
$caption id="attachment_150078" align="alignnone" width="428"$![Fig. 2: combinación de dos rotaciones en el espacio, tomadas en distinto orden](/taller-matematicas/assets/images/rotacions2.png) Fig. 2: combinación de dos rotaciones en el espacio, tomadas en distinto orden
...
![Fig. 3: Rotaciones según ángulos de Euler, 1ª rotación](/taller-matematicas/assets/images/Euler1.png) Fig. 3: Rotaciones según ángulos de Euler, 1ª rotación
...
![Fig. 4: segunda rotación de Euler](/taller-matematicas/assets/images/Euler2-300x254.png) Fig. 4: segunda rotación de Euler
...
$caption id="attachment_150085" align="alignnone" width="512"$![](/taller-matematicas/assets/images/Euler3-2.png) Fig. 5: tercera rotación de Euler, posición final, se indican los vectores rotación en rojo
...
$caption id="attachment_150090" align="alignnone" width="293"$![Fig. 6: composición simple de rotaciones](/taller-matematicas/assets/images/suma_rotacions.png) Fig. 6: composición simple de rotaciones
...
![Fig. 6: volante que gira solidariamente a una plataforma giratoria](/taller-matematicas/assets/images/cinematica_volant-300x235.png) Fig. 7: volante que gira en torno al eje aa', el cual a su vez puede oscilar en torno al eje bb' solidariamente a una plataforma que a su vez, puede oscilar según el eje cc'
...
$caption id="attachment_150089" align="alignnone" width="470"$![Fig. 7: ejes y ángulos de Euler para el volante del problema](/taller-matematicas/assets/images/cinematica_volant2.png) Fig. 8: una elección posible de ejes y ángulos de Euler para el volante del problema
...
![Fig. 8: coordenadas de un punto del disco](/taller-matematicas/assets/images/velocitat-base-mòbil7.png) Fig. 9: coordenadas de un punto del disco
