...
Observemos que $\int\frac{\left(\ln\left(x\right)\right)^3}x\operatorname{d}x=\int\left(\ln\left(x\right)\right)^3\cdot\frac{\operatorname{d}x}x=\int\left(\ln\left(x\right)\right)^3\cdot\operatorname{d}\left(\ln\left(x\right)\right)$, que se corresponde con la [integral inmediata](/taller-matematicas/2014/08/10/calculo-de-integrales-funciones-reales-de-variable-real/#tabla_inmediatas) del tipo (3). Por tanto:
...
Es una [integral del tipo racional](/taller-matematicas/2014/08/10/calculo-de-integrales-funciones-reales-de-variable-real/#racionales), pero antes de proceder según el método habitual, observemos que
...
Ambas [integrales son inmediatas](/taller-matematicas/2014/08/10/calculo-de-integrales-funciones-reales-de-variable-real/#tabla_inmediatas):
