...
![Fig. 1: diagrama de fuerzas estáticas](/taller-matematicas/assets/images/estatica1.png) Fig. 1: diagrama de fuerzas estáticas (los ángulos de las tensiones no se corresponden con los del enunciado)
...
![Fig. 1: problema del operario y la escalera](/taller-matematicas/assets/images/dinamica_basica1.png) Fig. 1: problema del operario y la escalera
...
![Fig. 2: cálculo del momento](/taller-matematicas/assets/images/dinamica_basica2.png) Fig. 2: cálculo del momento
...
![Fig. 3: cálculo del vector de posición del operario, Oq](/taller-matematicas/assets/images/dinamica_basica3.png) Fig. 3: cálculo del vector de posición del operario, Oq
