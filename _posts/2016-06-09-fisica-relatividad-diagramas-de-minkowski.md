...
[caption id="attachment_1716" align="aligncenter" width="405"]![Minkowski1c](/assets/images/Minkowski1c.png) Fig. 2: tres sistemas de referencia, el S' con v = c/2, el S'' con v = c/3[/caption]
...
[caption id="attachment_1718" align="alignnone" width="432"]![Fig. 3: hipérbola de calibración x² - (ct)² = 1](/assets/images/Minkowski2.png) Fig. 3: hipérbola de calibración x² - (ct)² = 1[/caption]
...
[caption id="attachment_1719" align="aligncenter" width="431"]![Fig. 4: determinar una longitud x](/assets/images/Minkowski3.png) Fig. 4: determinar una longitud x'=2 vista desde el sistema S en reposo[/caption]
...
[caption id="attachment_1721" align="aligncenter" width="406"]![Fig. 4: diagrama de Minkowski para situar los sucesos B, C](/assets/images/Minkowski4.png) Fig. 5: diagrama de Minkowski para situar los sucesos A, B[/caption]
...
[caption id="attachment_1722" align="aligncenter" width="498"]![Fig. 6: Diagrama para obtener las coordenada de los puntos del ejemplo anterior en otro sistema](/assets/images/Minkowski5.png) Fig. 6: Diagrama para obtener las coordenada de los puntos del ejemplo anterior en otro sistema[/caption]
...
[caption id="attachment_1730" align="aligncenter" width="381"]![Fig. 6: dos sucesos A, B, el primero representa una explosión, el segundo el despliegue de un escudo](/assets/images/Minkowski6.png) Fig. 7: dos sucesos A, B, el primero representa una explosión, el segundo el despliegue de un escudo[/caption]
