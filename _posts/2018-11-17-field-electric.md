...
![](/taller-matematicas/assets/images/camp_electr3.png) Fig.3: Single-load single-charge electric field lines are straight cut into the load
...
![](/taller-matematicas/assets/images/camp_electr4b.png) Fig. 4: field and field lines generated by two equal point loads
...
![](/taller-matematicas/assets/images/camp_electr5.png) Fig. 6: Geometry for the calculation of field E produced by a homogeneous load line at a point above the bisector of the line
...
![](/taller-matematicas/assets/images/Camp-central.png) Fig.7: Central field, the agent mass located in O
...
![](/taller-matematicas/assets/images/flux_vector.png) Fig. 8: surface differential element, vector dS, and vector field V that we assume passes through the center of the surface
...
![](/taller-matematicas/assets/images/angle_sòlid.png) Fig. 9: solid angle subtended on sphere C by surface element dS
...
![](/taller-matematicas/assets/images/angle_sòlid2.png) Fig. 10: dS' and d' are parallel, and are attached by the same lines to the central point O
...
![](/taller-matematicas/assets/images/flux_vector2.png) Fig.11: flows from the O center through closed surfaces
...
![](/taller-matematicas/assets/images/Gauss.png) Fig. 12: Using gauss's theorem to calculate electric field E
...
![](/taller-matematicas/assets/images/TGauss.png) By symmetry of the problem with any line that passes through O, the E field must have the same module on every inner S sphere, and it must be radial
...
![](/taller-matematicas/assets/images/camp_esfera.png) Variation of field E with distance r to center in the case of a radio sphere to evenly loaded
