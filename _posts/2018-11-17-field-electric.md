...
![](/taller-matematicas/assets/images/camp_electr.png) Fig.1: electrostatic force between two charges
...
$caption id="attachment_150804" align="alignleft" width="135"$![](/taller-matematicas/assets/images/camp_electr3.png) Fig.3: Single-load single-charge electric field lines are straight cut into the load
...
$caption id="attachment_150806" align="alignnone" width="387"$![](/taller-matematicas/assets/images/camp_electr4b.png) Fig. 4: field and field lines generated by two equal point loads
...
$caption id="attachment_150810" align="alignnone" width="452"$![](/taller-matematicas/assets/images/camp_electr5.png) Fig. 6: Geometry for the calculation of field E produced by a homogeneous load line at a point above the bisector of the line
...
$caption id="attachment_150816" align="alignnone" width="219"$![](/taller-matematicas/assets/images/Camp-central.png) Fig.7: Central field, the agent mass located in O
...
$caption id="attachment_150817" align="alignnone" width="219"$![](/taller-matematicas/assets/images/flux_vector.png) Fig. 8: surface differential element, vector dS, and vector field V that we assume passes through the center of the surface
...
$caption id="attachment_150818" align="alignnone" width="410"$![](/taller-matematicas/assets/images/angle_sòlid.png) Fig. 9: solid angle subtended on sphere C by surface element dS
...
$caption id="attachment_150819" align="alignnone" width="367"$![](/taller-matematicas/assets/images/angle_sòlid2.png) Fig. 10: dS' and d' are parallel, and are attached by the same lines to the central point O
...
$caption id="attachment_150820" align="alignnone" width="570"$![](/taller-matematicas/assets/images/flux_vector2.png) Fig.11: flows from the O center through closed surfaces
...
$caption id="attachment_150821" align="alignnone" width="421"$![](/taller-matematicas/assets/images/Gauss.png) Fig. 12: Using gauss's theorem to calculate electric field E
...
$caption id="attachment_150832" align="alignnone" width="341"$![](/taller-matematicas/assets/images/TGauss.png) By symmetry of the problem with any line that passes through O, the E field must have the same module on every inner S sphere, and it must be radial
...
$caption id="attachment_150834" align="alignnone" width="321"$![](/taller-matematicas/assets/images/camp_esfera.png) Variation of field E with distance r to center in the case of a radio sphere to evenly loaded
...
![](/taller-matematicas/assets/images/Esfera_carregada2.png) Vectors E and geometry of the problem
...
![](/taller-matematicas/assets/images/esfera_cavitat.png) The field inside a cavity within a uniformly charged sphere is constant
{% endraw %}