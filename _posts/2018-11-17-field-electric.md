...
[caption id="attachment_150801" align="aligncenter" width="297"]![](/assets/images/camp_electr.png) Fig.1: electrostatic force between two charges[/caption]
...
[caption id="attachment_150802" align="aligncenter" width="175"]![](/assets/images/camp_electr2.png) Fig.2: two test loads q, q' determine the origin of the electric field, the Q load, and the vector field E[/caption]
...
[caption id="attachment_150804" align="alignleft" width="135"]![](/assets/images/camp_electr3.png) Fig.3: Single-load single-charge electric field lines are straight cut into the load[/caption]
...
[caption id="attachment_150806" align="alignnone" width="387"]![](/assets/images/camp_electr4b.png) Fig. 4: field and field lines generated by two equal point loads[/caption]
...
[caption id="attachment_150810" align="alignnone" width="452"]![](/assets/images/camp_electr5.png) Fig. 6: Geometry for the calculation of field E produced by a homogeneous load line at a point above the bisector of the line[/caption]
...
[caption id="attachment_150816" align="alignnone" width="219"]![](/assets/images/Camp-central.png) Fig.7: Central field, the agent mass located in O[/caption]
...
[caption id="attachment_150817" align="alignnone" width="219"]![](/assets/images/flux_vector.png) Fig. 8: surface differential element, vector dS, and vector field V that we assume passes through the center of the surface[/caption]
...
[caption id="attachment_150818" align="alignnone" width="410"]![](/assets/images/angle_sòlid.png) Fig. 9: solid angle subtended on sphere C by surface element dS[/caption]
...
[caption id="attachment_150819" align="alignnone" width="367"]![](/assets/images/angle_sòlid2.png) Fig. 10: dS' and d' are parallel, and are attached by the same lines to the central point O[/caption]
...
[caption id="attachment_150820" align="alignnone" width="570"]![](/assets/images/flux_vector2.png) Fig.11: flows from the O center through closed surfaces[/caption]
...
[caption id="attachment_150821" align="alignnone" width="421"]![](/assets/images/Gauss.png) Fig. 12: Using gauss's theorem to calculate electric field E[/caption]
...
[caption id="attachment_150832" align="alignnone" width="341"]![](/assets/images/TGauss.png) By symmetry of the problem with any line that passes through O, the E field must have the same module on every inner S sphere, and it must be radial[/caption]
...
[caption id="attachment_150834" align="alignnone" width="321"]![](/assets/images/camp_esfera.png) Variation of field E with distance r to center in the case of a radio sphere to evenly loaded[/caption]
...
[caption id="attachment_150830" align="aligncenter" width="292"]![](/assets/images/Esfera_carregada2.png) Vectors E and geometry of the problem[/caption]
