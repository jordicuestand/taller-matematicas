...
![](/taller-matematicas/assets/images/teoria_cinetica1.png) Fig. 1: moléculas de un gas en movimiento aleatorio
...
![](/taller-matematicas/assets/images/teoria_cinetica2.png) Fig.2: moléculas moviéndose en la dirección X dentro de un pequeño volumen d·S
