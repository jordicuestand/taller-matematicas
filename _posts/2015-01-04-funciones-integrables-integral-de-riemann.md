...
Además, en los casos prácticos de cálculo de integrales, lo que se hace es obtener la primitiva F de la función para después, aplicando la regla de Barrow, obtener la integral, ya que el cálculo directo usando las sumas de Riemann puede ser complicado y largo. Las técnicas de obtención de la función primitiva F se ven en el artículo [Cálculo de integrales](/taller-matematicas/2014/08/10/calculo-de-integrales-funciones-reales-de-variable-real/). Ejemplos de aplicación de las integrales se verán en el artículo Problemas resueltos de aplicaciones de las integrales.
