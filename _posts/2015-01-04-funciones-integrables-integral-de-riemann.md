...
[caption id="attachment_675" align="alignnone" width="414"][![Àrea de la región comprendida entre un intervalo de x y la gráfica f(x)](/assets/images/area.png)](http://tallermatematic.eu/wp/wp-content/uploads/2015/01/area.png) Àrea de la región comprendida entre un intervalo de x y la gráfica f(x)[/caption]
...
[caption id="attachment_677" align="alignnone" width="189"][![Aproximación al área por rectángulos](/assets/images/area_sup-189x300.png)](http://tallermatematic.eu/wp/wp-content/uploads/2015/01/area_sup.png) Aproximación al área por rectángulos, tomando el extremo superior de cada intervalo: suma superior de Riemann[/caption]
...
[caption id="attachment_682" align="alignnone" width="358"][![Función escalonada con infinitos puntos de discontinuidad](/assets/images/area2.png)](http://tallermatematic.eu/wp/wp-content/uploads/2015/01/area2.png) Función escalonada con infinitos puntos de discontinuidad[/caption]
...
[![Exemple8_integral_Riemann_b](/assets/images/Exemple8_integral_Riemann_b-300x201.png)](http://tallermatematic.eu/wp/wp-content/uploads/2015/01/Exemple8_integral_Riemann_b.png)
...
[![Exemple8_integral_Riemann](/assets/images/Exemple8_integral_Riemann-300x197.png)](http://tallermatematic.eu/wp/wp-content/uploads/2015/01/Exemple8_integral_Riemann.png)
