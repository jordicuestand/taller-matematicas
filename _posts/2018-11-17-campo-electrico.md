...
$caption id="attachment_150801" align="aligncenter" width="297"$![](/taller-matematicas/assets/images/camp_electr.png) Fig.1: fuerza electrostática entre dos cargas[/caption]
...
$caption id="attachment_150802" align="aligncenter" width="175"$![](/taller-matematicas/assets/images/camp_electr2.png) Fig.2: dos cargas de prueba q, q' determinan el origen del campo eléctrico, la carga Q, y el vector campo E[/caption]
...
$caption id="attachment_150804" align="alignleft" width="135"$![](/taller-matematicas/assets/images/camp_electr3.png) Fig.3: las líneas del campo eléctrico de una única carga puntual son rectas que se cortan en la carga[/caption]
...
$caption id="attachment_150806" align="alignnone" width="387"$![](/taller-matematicas/assets/images/camp_electr4b.png) Fig. 4: campo y lineas de campo generadas por dos cargas puntuales iguales[/caption]
...
$caption id="attachment_150810" align="alignnone" width="452"$![](/taller-matematicas/assets/images/camp_electr5.png) Fig. 6: geometría para el cálculo del campo E producido por una línea homogénea de carga en un punto situado sobre la bisectriz de la línea[/caption]
...
$caption id="attachment_150816" align="alignnone" width="219"$![](/taller-matematicas/assets/images/Camp-central.png) Fig.7: Campo central, la masa agente situada en O[/caption]
...
$caption id="attachment_150817" align="alignnone" width="219"$![](/taller-matematicas/assets/images/flux_vector.png) Fig. 8: elemento diferencial de superficie, vector dS, y campo vectorial V que suponemos pasa por el centro de la superficie[/caption]
...
$caption id="attachment_150818" align="alignnone" width="410"$![](/taller-matematicas/assets/images/angle_sòlid.png) Fig. 9: ángulo sólido subtendido sobre la esfera C por el elemento de superficie dS[/caption]
...
$caption id="attachment_150819" align="alignnone" width="367"$![](/taller-matematicas/assets/images/angle_sòlid2.png) Fig. 10: dS' y dΩ son paralelas, y están unidas por las mismas rectas al punto central O[/caption]
...
$caption id="attachment_150820" align="alignnone" width="570"$![](/taller-matematicas/assets/images/flux_vector2.png) Fig.11: flujos provenientes del centro O a través de superficies cerradas[/caption]
...
$caption id="attachment_150821" align="alignnone" width="421"$![](/taller-matematicas/assets/images/Gauss.png) Fig. 12: usando el teorema de Gauss para calcular el campo eléctrico E[/caption]
...
$caption id="attachment_150832" align="alignnone" width="341"$![](/taller-matematicas/assets/images/TGauss.png) Por simetría del problema respecto cualquier recta que pase por O, el campo E ha de tener el mismo módulo en toda esfera S interior, y ha de ser radial[/caption]
...
$caption id="attachment_150834" align="alignnone" width="321"$![](/taller-matematicas/assets/images/camp_esfera.png) Variación del campo E con la distancia r al centro en el caso de una esfera de radio a cargada uniformemente[/caption]
...
$caption id="attachment_150830" align="aligncenter" width="292"$![](/taller-matematicas/assets/images/Esfera_carregada2.png) Vectores E y geometria del problema[/caption]
...
$caption id="attachment_150835" align="aligncenter" width="205"$![](/taller-matematicas/assets/images/esfera_cavitat.png) El campo en el interior de una cavidad dentro de una esfera uniformemente cargada es constante[/caption]
{% endraw %}