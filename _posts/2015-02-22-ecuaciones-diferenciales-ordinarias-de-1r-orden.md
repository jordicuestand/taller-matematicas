...
![Dos rectas de un haz (azul y rojo) y curva envolvente del haz (verde)](/taller-matematicas/assets/images/Feix_corbes_env1.png) Dos rectas de un haz (azul y rojo) y curva envolvente del haz (verde)
...
![Haz de parábolas 4y=(x + C)²](/taller-matematicas/assets/images/Feix_corbes_env.png) Haz de parábolas 4y=(x + C)²
