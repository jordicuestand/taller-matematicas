...
![separador2]({{ '/assets/images/separador2.png' | relative_url }})
...
![Dos soluciones de 2y](/taller-matematicas/assets/images/no_lineal_ordinaria.png) Dos soluciones de 2y'² - y' + x = 0
...
que es una [ecuación diferencial lineal](/taller-matematicas/2015/03/28/ecuaciones-diferenciales-lineales-de-1r-orden/); la lineal homogénea es $p'+\frac1xp=0$, de variables separables:
...
![parametricas]({{ '/assets/images/parametricas.png' | relative_url }}) Algunos puntos (x,y) obtenidos de las ecuaciones paramétricas
...
**Ejemplo 4**: La ecuación $4y=x^2+(y')^2$ es del tipo "se puede despejar y"; probemos el cambio $y'=p$ que la transforma en $4y=x^2+p^2$. Derivando respecto de x: $4p=2x+2pp'$, que es del tipo $p'=F(x,p)$ con F homogénea de grado 0 (ver [Funciones homogéneas. Aplicación a las ecuaciones diferenciales](/taller-matematicas/2015/02/22/ecuaciones-diferenciales-ordinarias-de-1r-orden/#homogeneas)):
...
Multipliquemos todo por $2v^{1/2}$ para obtener $v'-\frac3xv=4x$ que és lineal. Resolvemos esta ecuación usando la fórmula general (ver el post [Ecuaciones diferenciales lineales de 1r orden](/taller-matematicas/2015/03/28/ecuaciones-diferenciales-lineales-de-1r-orden/)):
