...
La combinatoria es la teoría matemática que trata de las técnicas para contar el número de elementos de un subconjunto, o el número de subconjuntos de un conjunto, o el número de listas de elementos del conjunto determinados por un criterio. Algunos problemas de [probabilidades](/taller-matematicas/2015/09/25/introduccion-a-las-probabilidades/) utilizan estas técnicas, de las que  aquí vemos un repaso breve.
