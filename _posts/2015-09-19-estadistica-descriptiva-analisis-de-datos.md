...
![Resumir datos: parámetros y gráficos estadísticos ](/taller-matematicas/assets/images/grafic_est_descrip.png) Resumir datos: parámetros y gráficos estadísticos
...
![De los datos experimentales a las predicciones](/taller-matematicas/assets/images/inferencia_esquema.png) De los datos experimentales a las predicciones
...
![Fase 1: Estadística descriptiva resumen de los datos](/taller-matematicas/assets/images/fase1_estad.png) Fase 2: Estadística descriptiva resumen de los datos
...
![Ejemplo de tabla de frecuencias y su representación gráfica](/taller-matematicas/assets/images/est-descrp.png) Ejemplo de tabla de frecuencias y su representación gráfica
...
![Opciones de tipo de gráfico en OpenOffice](/taller-matematicas/assets/images/graph_types.png) Opciones de tipo de gráfico en OpenOffice
...
![Histograma de datos agrupados en categorías](/taller-matematicas/assets/images/descript_tots.png) Histograma de datos agrupados en categorías
...
![Datos según las categorías máquinas y operarios](/taller-matematicas/assets/images/descript-categories.png) Datos según las categorías máquinas y operarios
...
![ ](/taller-matematicas/assets/images/taula_freq.png) Tabla de datos agrupados en clases, con las frecuencias absolutas y relativas
...
![Los tres quartiles dividen el rango de datos en cuatro partes iguales, con un 25% de los datos cada una ](/taller-matematicas/assets/images/quartils.png) Los tres cuartiles dividen el rango de datos en cuatro partes iguales, con un 25% de los datos cada una
...
![Polígono acumulativo de frecuencias, y obtención del percentil 20](/taller-matematicas/assets/images/poligon_acumulatiu.png) Polígono acumulativo de frecuencias, y obtención del percentil 20
...
![Triángulos semejantes en el polígono de frecuencias acumuladas](/taller-matematicas/assets/images/percentils.png) Triángulos semejantes en el polígono de frecuencias acumuladas
...
![Histograma de frecuencias absolutas](/taller-matematicas/assets/images/exemple1_descriptiva.png) Histograma de frecuencias absolutas
